...
class Grammar:
    ...
    def __init__(self, name: str,
        ...
        if len(eps_terminal) > 1:
            raise GrammarException('Eps-символ должен быть длинны 1', eps_terminal=eps_terminal)
    ...
    def delete_eps_rules(self):
        """
        Возвращает: Грамматика без епс-правил
        """
    ...
    def delete_direct_left_recursion(self):
        """
        Возвращает: Грамматика без непосредственной левой рекурсии
        """
    ...
    def delete_left_recursion(self):
        """
        Возвращает: Грамматика без левой рекурсии
        """
        self.has_circuits(raise_exception=True)  # Проверка на наличие цепей в грамматике
    ...
    def is_eps_rule(self, rule: NoTermSymbol) -> bool:
        """
        rule - Левая часть правила (нетерминал)
        """
